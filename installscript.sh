...
curl https://raw.githubusercontent.com/nalinwadhwa02/dotfiles/master/i3/config >> /home/${user}/.config/i3/config
curl https://raw.githubusercontent.com/nalinwadhwa02/dotfiles/master/autostart.sh >> /home/${user}/.config/autostart.sh
